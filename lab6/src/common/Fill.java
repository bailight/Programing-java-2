...
public class Fill {
	public Vehicle fillvehicle() throws InvalidInput, IOException, IllegaValue {
    	Vehicle vehicle = new Vehicle(readName(), readCoordinates(), LocalDate.now(), readEnginePower(), readCapacity(), readDistanceTravelled(), readFuelType());
    	return vehicle;
    }
