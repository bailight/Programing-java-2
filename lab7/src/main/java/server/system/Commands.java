...
public class Commands {
    ...
    public static String executeCommand(Request request, User user) throws NoSuchCommand, ScriptException, InvalidInput {
        String name = request.getCommand();
        Command command = commands.get(name);
        String argument = request.getArgument();
        Object object = request.getObject();
        return command.execute(argument, object, user);
    }
